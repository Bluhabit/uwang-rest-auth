...
pub const REDIS_KEY_OTP_ATTEMPT: &str = "otp";
...
pub const TTL_OTP_SIGN_IN: i64 = 14400;
pub const TTL_OTP_SIGN_UP: i64 = 14400;
pub const TTL_OTP_FORGOT_PASSWORD: i64 = 240;
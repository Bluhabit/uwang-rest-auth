...
public class RoleController {
    ...
    public ResponseEntity<BaseResponse<Page<Role>>> getRoles(Pageable pageable) {
    ...
    public ResponseEntity<BaseResponse<List<Role>>> searchRole(@RequestParam("query") String query) {

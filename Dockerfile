...
EXPOSE 7001
ENTRYPOINT ["java","-Djavax.persistence.jdbc.url=jdbc:postgresql://host.docker.internal:6500/uwang-dev","-Dspring.datasource.username=bluehabit","-Dspring.datasource.password=Bluehabit2023Baru","-Dspring.datasource.hikari.driver-class-name=org.postgresql.Driver","-jar","/app/uwang-app.jar"]

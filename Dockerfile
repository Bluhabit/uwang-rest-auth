...
EXPOSE 7001
ENTRYPOINT ["java","-Djavax.persistence.jdbc.url=jdbc:postgresql://203.194.112.146:6500/uwang-dev","-Dspring.datasource.username=bluehabit","-Dspring.datasource.password=Bluehabit2023Baru","-jar","/app/uwang-app.jar"]
